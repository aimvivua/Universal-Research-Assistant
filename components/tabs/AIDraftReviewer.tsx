...
import { reviewDraftWithPersona } from '../../services/geminiService';
import Loader from '../Loader';
import { UserVoiceIcon, BrainCircuitIcon, BalanceScaleIcon, GlobeCommunityIcon } from '../icons/Icons';
        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                    <h2 className="text-xl font-semibold text-slate-700 mb-2">Choose a Reviewer Persona</h2>
